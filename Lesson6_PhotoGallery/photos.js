...
function previewFive() {
    ...
    // create figure and img elements for the 5th image
   ...
   //clone figure element for 5th image and edit to be first image
...
function createEventListeners() {
   ...
   //the rightArrow() function will execute when the user clicks the right navigation arrow
